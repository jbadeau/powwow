define([ 'dejavu/Class', 'mout/lang' ], function(Class, lang) {
	...
	var BadParametersError = Class.declare({
		...
		$statics : {
			 ...
			 *            This message is provided by the user.
			 * @param msgvarargs
			 *            {var} any number of parts of a message to show if
			 *            assertion triggers. Each will be converted to a string
			 *            and all parts will be concatenated. E. g. instead of
			 *            "Got invalid value " + this._toString(val) + "!!!!!"
			 *            use "Got invalid value ", val, "!!!!!" (much better
			 *            performance)
			 * 
			 */
			...
			assertQxObject : function(value, msg) {
				this.__isQxInstance(value, "qx.core.Object") || this._fail(msg || "", "Expected value to be a qooxdoo object but found ", value, "!");
			},
			...
			assertQxWidget : function(value, msg) {
				this.__isQxInstance(value, "qx.ui.core.Widget") || this._fail(msg || "", "Expected value to be a qooxdoo widget but found ", value, "!");
			},

			/**
			 * Internal helper for checking the instance of a qooxdoo object
			 * using the classname.
			 * 
			 * @param object
			 *            {var} The object to check.
			 * @param classname
			 *            {String} The classname of the class as string.
			 * @return {Boolean} <code>true</code> if the object is an
